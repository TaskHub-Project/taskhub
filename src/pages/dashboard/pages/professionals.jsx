  ...
  return (
    <div className="px-4 md:px-7">
      ...
      <div className="pt-10 flex flex-col md:flex-row">
        ...
        <div className="max-w-md w-full mx-auto bg-white shadow-lg rounded-lg overflow-hidden py-10 mb-6 md:mb-0 md:mr-4">
        ...
        <div className="max-w-md w-full mx-auto bg-white shadow-lg rounded-lg overflow-hidden py-10">
          <div className="flex items-center p-6">
            <img
              src={blackman}
              alt="Plumber"
